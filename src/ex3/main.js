...
class Main {
    ...
    onDeleteAllBtnClicked() {
        this.localStorageManager.cleanLocalStorageTable();
        this.render();
    }
    ...
    showTodosList() {
        const todoListdata = this.localStorageManager.getTableFromLocalStorage();
    ...
    deleteTodo(element) {
        this.localStorageManager.removeItemFromLocalStorage(element);
        this.render();
    }
