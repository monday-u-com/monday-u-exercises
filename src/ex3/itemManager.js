class ItemManager {
    ...
    insertItem({ item, checked, pokemon, type, message }) {
        this.localStorageManager.addItemToLocalStorage({
            type,
            item,
            checked,
            pokemon,
    ...
    isPokemonExist(pokemon) {
        const itemsListData = this.localStorageManager.getTableFromLocalStorage();
    ...
    editItem(element, newItem) {
        ...
        this.localStorageManager.editItemLocalStorage(element, newElement);
    }

    getItemsLength() {
        return this.localStorageManager.getTableFromLocalStorage()?.length;
    }

    updateItemCheckbox(element) {
        element.checked = !element.checked;
        this.localStorageManager.editItemLocalStorage(element, element);
    }
